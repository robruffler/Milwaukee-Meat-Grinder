try {
	(function() {
		...
		function saveText() {
			var possibilities = [
				...
				"Take a look inside, it's content in a box",
				"More than just content, it's Fauxwerd",
				"Oooh, yeah, I'm the Content Man",
				"I'm saving your content, Dave"
			];
		...
		FW.fdoc.write('<div style="background: #EEE; border: 2px solid #DDD; color: #000; text-align: center; margin: 10px auto 0; padding: 3px 5px; font: bold 12px verdana">'+ saveText() +'</div>');
	...
	// Must be in IE..
	location = "http://"+FW.env+"/save?url="+FW.l.href;
}